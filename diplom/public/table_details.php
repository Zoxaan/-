...
<style>
    body {
        ...
        color: #333; /* изменение цвета текста на более темный */
    }
    ...
    h1 {
        font-size: 36px; /* увеличение размера заголовка */
        margin-bottom: 20px;
    }
    ...
    .table-info {
        margin-top: 2%;
        border-radius: 10px;
        background-color: rgba(215 215 215 / 80%); /* темный серый с прозрачностью */
        float: right;
        width: calc(50% - 10px); /* вычисление ширины с учетом отступов */
        padding: 20px;
    ...
    .table-img {
        margin-top: 2%;
        max-width: 50%; /* изображение занимает всю доступную ширину */
        height: auto;
        margin-bottom: 20px;
        border-radius: 8px;
    ...
    .menu-section {
        margin-top: 50px; /* увеличение отступа сверху */
    }

    .menu-section h2 {
        font-size: 30px; /* уменьшение размера заголовка */
        margin-bottom: 20px;
    }
 ...
 {
    .blur{
        filter: blur(8px); /* Применяем размытие фона */
        pointer-events: none; /* Элементы не реагируют на события мыши */
    }
...
<script>
    ...
    function closeModal() {
        ...
        document.body.classList.remove("blur"); // Убираем класс blur из body
    }
